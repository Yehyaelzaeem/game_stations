...
class AndroidFlutterLocalNotificationsPlugin
  ...
  AndroidNotificationSound _getNotificationChannelSound(
    ...
    final Object? soundSourceIndex = channelMap!['soundSource'];
    AndroidNotificationSound? sound;
    if (soundSourceIndex != null) {
      if (soundSourceIndex ==
          AndroidNotificationSoundSource.rawResource.index) {
        sound = RawResourceAndroidNotificationSound(channelMap!['sound'].toString());
      } else if (soundSourceIndex == AndroidNotificationSoundSource.uri.index) {
        sound = UriAndroidNotificationSound(channelMap!['sound'].toString());
      }
    }
    return sound!;
  }
