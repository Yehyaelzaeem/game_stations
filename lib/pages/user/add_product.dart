                                        ...
                                        child: GestureDetector(
                                          onTap: value.isLoading
                                              ...
                                              : () async {
                                                  ...
                                                  if (imageFileUploadOne != null || imageFileUploadTwo != null || descriptionTextController.text.toString().trim().isNotEmpty && priceTextController.text.toString().trim().isNotEmpty && titleTextController.text.toString().trim().isNotEmpty) {
                                                    List<MultipartFile> multipartImageList = [];
                                                    List<File> images_file = [];
                                                    // if (null != images) {
                                                    //   for (Asset asset in images) {
                                                    //     print("ESSAMPATH===============================================>${asset.identifier} ${asset.name}");
                                                    //
                                                    ...
                                                    // }
                                                    print('------> addProduct');
                                                    await categoryProvider!.addProduct(context: context, country: "${Constant.country}", price: priceTextController.text.toString().trim(), text: descriptionTextController.text.toString().trim(), title: titleTextController.text.toString().trim(), images: images_file, catID: _statusSelDeptKind.toString(), cityID: _statusSelCityKind.toString(), type: old == false ? "0" : "1");
                                                    print('------> finish addProduct');
