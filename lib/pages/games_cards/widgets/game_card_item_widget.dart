...
class GameCardItemWidget extends StatelessWidget {
  GameCardItemWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    GameCardModel model = Provider.of<GameCardModel>(context);
    CartProvider cartProvider = Provider.of<CartProvider>(context);

    return GestureDetector(
      onTap: () {
        Navigator.of(context).pushNamed(GameCardDetailsScreen.routeName, arguments: model);
      },
      child: Container(
